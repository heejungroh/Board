...
public class BoardController {
	...
	@GetMapping({"","/","/list"})//중괄호하면 주소 여러개 걸수있음. //페이징//size:몇개씩,sort:어떤기준으로 정렬할껀지
	...
	@GetMapping("/list/test")//중괄호하면 주소 여러개 걸수있음. //페이징//size:몇개씩,sort:어떤기준으로 정렬할껀지
	@ResponseBody
	...
	public String detail(@PathVariable int id,Model model) throws Exception{
		//Optional<Board> opBoard=boardRepository.findById(id);//하나의 오브젝트만 넣어라
